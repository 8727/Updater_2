...
namespace Updater_2
{
    internal class Web_UpdateFactor
    {
        ...
        //static readonly HttpClient HttpClient = new HttpClient(HttpClientHandler, disposeHandler: false);

        //static async Task<string> GetStateAsync(string ipAddress)
        //{
        //    try
        //    {
        //        using (var request = new HttpRequestMessage(HttpMethod.Get, $"http://{ipAddress}:{UI.web_port}/updater/state"))
        ...
        //static async Task<bool> UploadFileAsync(string ipAddress, string filePath)
        //{
        //    try
        //    {
        //        using (var fileStream = File.OpenRead(filePath))
        ...
        //            using (var response = await HttpClient.PostAsync($"http://{ipAddress}:{UI.web_port}/updater/upload", content))
        //            {
        //                return response.IsSuccessStatusCode;
        //            }
        //        }
        ...
        //static async Task<bool> SendInstallCommandAsync(string ipAddress)
        //{
        //    try
        //    {
        //        using (var content = new StringContent(""))
        ...
        //            using (var response = await HttpClient.PostAsync($"http://{ipAddress}:{UI.web_port}/updater/install", content))
        //            {
        //                return response.IsSuccessStatusCode;
        //            }
        //        }
        ...
        //static async Task<bool> SendCancelCommandAsync(string ipAddress)
        //{
        //    try
        //    {
        //        using (var content = new StringContent(""))
        ...
        //            using (var response = await HttpClient.PostAsync($"http://{ipAddress}:{UI.web_port}/updater/cancel", content))
        //            {
        //                return response.IsSuccessStatusCode;
        //            }
        //        }
        ...
        //    do
        //    {
        //        state = await GetStateAsync(ipAddress);
        //        if ((state == "undefined" || state == "uploading") && attempts > 0)
        //        {
        //            await SendCancelCommandAsync(ipAddress);
        ...
        //    do
        //    {
        //        uploadSuccess = await UploadFileAsync(ipAddress, filePath);
        //        if (!uploadSuccess && attempts > 0)
        //        {
        //            await SendCancelCommandAsync(ipAddress);
        //            await Task.Delay(500);
        //        }
        ...
        //    do
        //    {
        //        installSuccess = await SendInstallCommandAsync(ipAddress);
        //        if (!installSuccess && attempts > 0)
        //        {
        //            await SendCancelCommandAsync(ipAddress);
        //            await Task.Delay(500);
        //        }
        ...
        //        await ProcessFileAsync(ip, file, rowIndex);
        //        UI.StepProgressBar();
        //    }
        //    return false;
        //}
